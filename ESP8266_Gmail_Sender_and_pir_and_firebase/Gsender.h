...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "cGpjaXAxOTk5QGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "MjQxMjE5OTk=";
        const char* FROM = "pjcip1999@gmail.com";
    ...
    public:
        ...
        bool Send(const String &to, const String &message);//In this const int &count is changed for my convenience
